...
export const SManageCvLayoutNavLinkChip = styled(Chip)`
  min-width: 16px;
`;
...
export const SManageCvLayoutCompletion = styled(Flex)`
  ${({ theme }) => `
    margin-top: auto;
    padding: ${theme.spacing(5)} 0 ${theme.spacing(2.5)};
  `}
`;
...
export const SManageCvLayoutNavContent = styled(CardContent)`
...
export const SManageCvLayoutBrand = styled(Flex)`
  img {
    flex-shrink: 0;
  }
`;
